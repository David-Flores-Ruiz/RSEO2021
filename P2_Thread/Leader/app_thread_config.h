...
/*! The channel mask used when a network scanning is performed (energy scan, active scan or both);
   ...
   e.g.: to set mask for channel 25, set THR_SCANCHANNEL_MASK to: (0x00000001 << 25) */
    ...
    #define THR_SCANCHANNEL_MASK                        (0x00000001 << 12)	// EQ2 canal 12
#endif
...
#ifndef THR_PAN_ID
    #define THR_PAN_ID                                  0x0202	// EQ2 PAN ID 0x0202 // THR_ALL_FFs16
#endif
...
/*! The default network name */
    ...
    #define THR_NETWORK_NAME                           {9, "EQ2_MYNWK"}	// EQ2 NETWORK	// {14, "Kinetis_Thread"}
#endif
